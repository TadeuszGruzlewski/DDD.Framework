...
public record class AccessoryItem(BaggageSize Size, Weight Weight, string Description, BaggageAllowance Allowance) : BaggageItem(Size, Weight, Description, Allowance)
{
